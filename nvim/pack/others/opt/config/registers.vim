...
" let g:registers_show_empty_registers = 1 "1 by default, an additional line with the registers without content
" let g:registers_trim_whitespace = 1 "1 by default, don't show whitespace at the begin and end of the registers
